...
int main()
{
	...
	/*Este open va a bloquear el proceso si no hay ningÃēn proceso que haya abierto la FIFO para escritura.*/

	fd = open(FIFO_NAME, O_WRONLY);

	/*Si bloquea, ni bien un proceso abra el FIFO para escritura se desbloquea este proceso y continÃēa con el printf siguiente*/

	printf("EncontrÃŠ un lector--tipee algo\n");
